          ...
          {faqs.map(({question, answer}, faqIndex) => (
            <div key={question} className="border-t border-stone-400 border-dotted py-6 last:border-b md:py-8 lg:py-10 relative isolate group/faq" onClick={() => {
              ...
              <div className={twMerge("flex items-center justify-between gap-4 transition-all duration-700 group-hover/faq:lg:px-8", faqIndex === selectedIndex && "lg:px-8")}>
                ...
                <div className={twMerge("inline-flex items-center justify-center size-11 border cursor-pointer border-stone-400 rounded-full shrink-0", faqIndex === selectedIndex && "rotate-45 transition-all duration-700")}>
